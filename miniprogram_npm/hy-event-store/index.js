...
__DEFINE__(1680096274110, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1680096274111,"./event-store":1680096274112}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1680096274111, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1680096274112, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1680096274111,"./utils":1680096274113}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1680096274113, function(require, module, exports) {
...
return __REQUIRE__(1680096274110);
})()
