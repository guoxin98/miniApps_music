...
__DEFINE__(1677660780776, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1677660780777,"./event-store":1677660780778}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677660780777, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1677660780778, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1677660780777,"./utils":1677660780779}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677660780779, function(require, module, exports) {
...
return __REQUIRE__(1677660780776);
})()
