...
__DEFINE__(1680840400406, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1680840400407,"./event-store":1680840400408}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1680840400407, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1680840400408, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1680840400407,"./utils":1680840400409}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1680840400409, function(require, module, exports) {
...
return __REQUIRE__(1680840400406);
})()
